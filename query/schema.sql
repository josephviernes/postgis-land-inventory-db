...
CREATE TABLE ground_reports_staging (
    index_no TEXT,
    report_date TEXT,
    province TEXT,
    municipality TEXT,
    ...
    nego_phase TEXT,
    price_sale TEXT,
    payment_terms_sale TEXT,
    price_lease TEXT,
    contract_terms_lease TEXT,
    nego_count TEXT,
...
CREATE TABLE ground_reports_refined (
    index_no BIGINT UNIQUE NOT NULL,
    ...
    lot_area NUMERIC,
    nego_phase VARCHAR(25) NOT NULL,
    price_sale NUMERIC,
    payment_terms_sale VARCHAR(20),
    price_lease NUMERIC,
    contract_terms_lease VARCHAR(20),
    nego_count SMALLINT,
    registered_owner VARCHAR(60),
...
CREATE TABLE ground_reports_refined_records (
    index_no BIGINT NOT NULL,
    report_date DATE NOT NULL,
    province VARCHAR(50),
    municipality VARCHAR(50),
    tax_dec VARCHAR(50),
